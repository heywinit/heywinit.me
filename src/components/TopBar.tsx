...
export default function TopBar() {
	...
	return (
		<div className="flex flex-col items-center justify-center w-full bg-primary p-1 pb-0">
			<div className="flex justify-between items-center w-full px-4 py-4 bg-card backdrop-blur-sm font-mono border border-primary rounded-sm">
