  ...
  return (
    ...
    >
      ...
      <button
        disabled={!value}
        type="submit"
        className="disabled:bg-gray-100 absolute right-2 top-1/2 z-50 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full bg-black transition duration-200 dark:bg-zinc-900 dark:disabled:bg-zinc-800"
      >
        <motion.svg
