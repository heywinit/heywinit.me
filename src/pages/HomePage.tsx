	...
	<Card className="mb-6 border-border bg-background">
		...
		<CardContent>
			...
			<p>
				...
				, where i do web3 stuff around eth and sol.
			</p>
		</CardContent>
	</Card>
);
	...
	<Card className="mb-6 border-border bg-background">
		...
		<CardContent>
			<p>
				...
				<span className="text-purple-500 dark:text-purple-400">kotlin</span>,
				and <span className="text-amber-500 dark:text-amber-400">python</span>.
			</p>
			<p>
	...
	<Card className="mb-6 border-border bg-background">
		...
		<CardContent>
			<p>
				...
				<span className="text-sky-500 dark:text-sky-400">tailwind</span>, and{" "}
